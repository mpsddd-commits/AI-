...
# st.title("도시별 평균 출발 지연시간")

# query = """
# SELECT 도시, cnt_1987, cnt_1988, cnt_1989, delay_1987, delay_1988, delay_1989
# FROM db_air.출발지연횟수
# ORDER BY 도시
# """
...
# # delay 컬럼만 사용
# df_delay = df[['도시','delay_1987','delay_1988','delay_1989']]

# # wide → long 변환
# df_delay = df_delay.melt(
#     id_vars='도시',
#     var_name='년도',
#     value_name='지연시간'
# )
...
st.title("✈️ 항공 출발 지연 데이터 분석 대시보드")
