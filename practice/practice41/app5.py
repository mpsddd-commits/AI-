    ...
    if len(arr) > 0:
      for row in arr:
        sql1 = f"""
            ...
            VALUE
            ('{row["id"]}','{gnrCode}', '{row["img"]}', '{row["title"]}', '{row["album"]}', {row["cnt"]});
        """
        save(sql1)
  return arr
...
# def crawl_all():
#     total = []
#     genres = ["GN0100","GN0200","GN0300","GN0400","GN0500","GN0600","GN0700","GN0800"]
#     for gnr in genres:
#       print(f"{gnr} 크롤링 시작")
#       result = crawlingMelon(gnr)
#       total.extend(result)
...
for gnr in genres:
  print(crawlingMelon(gnr))
# print(crawlingMelon("GN000"))